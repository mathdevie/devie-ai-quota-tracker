...
/// Public installed-application client of Google's Gemini CLI (`code_assist/oauth2.ts`).
pub const CLIENT_ID: &str =
    "681255809395-oo8ft2oprdrnp9e3aqf6av3hmdib135j.apps.googleusercontent.com";
/// Published in the same file; Google treats installed-app secrets as
/// non-confidential: <https://developers.google.com/identity/protocols/oauth2#installed>
