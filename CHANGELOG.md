...
- The Codex reset news reloads every minute and on a manual refresh. A
  long-running app kept the first answer and missed new forecasts.
- The news is fetched only when a Codex account is enabled.
